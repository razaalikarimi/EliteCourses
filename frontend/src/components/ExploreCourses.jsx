      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="lg:w-1/3 text-center lg:text-left space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 font-medium text-lg leading-relaxed">
              Find the perfect course to advance your career. Join over 20,000
              students learning from world-class industry professionals.
            </p>
          </div>
        ...
        <div className="lg:w-2/3 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {categories.map((cat, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl ${cat.bg} flex items-center justify-center ${cat.color} mb-4 group-hover:scale-110 transition-transform`}
              >
                <cat.icon size={28} />
              </div>
